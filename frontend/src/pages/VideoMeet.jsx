...
export default function VideoMeetComponent() {
    ...
    const sharedScreenRef = useRef(null); // Reference for the shared screen video element
    ...
    let getDislayMedia = () => {
     ...
     const startScreenShare = async () => {
        try {
            ...
            // Stop screen sharing when the user stops the stream
    ...
    <div>
        {askForUsername === true ? (
            ...
            <div className={isScreenSharing ? styles.screenShareMode : styles.meetVideoContainer}>
                {showModal && (
                ...
                <div className={styles.buttonContainers}>
                    ...
                    {screenAvailable === true && (
                        <IconButton onClick={startScreenShare} style={{ color: "white" }}>
                            {isScreenSharing === true ? <StopScreenShareIcon /> : <ScreenShareIcon />}
                        </IconButton>
                    )}
